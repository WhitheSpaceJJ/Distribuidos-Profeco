...
import entidades.entidades_supermercados.Comentarios;
 ...
 * @author josej
 */
public class ComentarioCola implements AutoCloseable {

    private com.rabbitmq.client.Connection connection;
    private com.rabbitmq.client.Channel channel;
    private String requestQueueName = "rpc_queue_comentarios";

    public ComentarioCola() throws IOException, TimeoutException {
    ...
    public boolean guardar(Comentarios message) throws IOException, InterruptedException, ExecutionException {
    ...
    public boolean actualizar(Comentarios message) throws IOException, InterruptedException, ExecutionException {
        final String corrId = UUID.randomUUID().toString();
    ...
    public Comentarios obtenerID(int id) throws IOException, InterruptedException, ExecutionException {
        final String corrId = UUID.randomUUID().toString();
        ...
        final CompletableFuture<Comentarios> response = new CompletableFuture<>();
    ...
    public Comentarios[] listar() throws IOException, InterruptedException, ExecutionException {
        final String corrId = UUID.randomUUID().toString();
