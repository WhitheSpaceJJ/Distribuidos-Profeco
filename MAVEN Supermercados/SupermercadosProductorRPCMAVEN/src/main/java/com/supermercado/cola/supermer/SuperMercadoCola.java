 ...
 */
package com.supermercado.cola.supermer;

import com.supermercado.cola.comen.*;
 ...
 * @author josej
 */
public class SuperMercadoCola implements AutoCloseable {

    private com.rabbitmq.client.Connection connection;
    private com.rabbitmq.client.Channel channel;
    private String requestQueueName = "rpc_queue_supermercados";

    public SuperMercadoCola() throws IOException, TimeoutException {
    ...
    public boolean guardar(Supermercados message) throws IOException, InterruptedException, ExecutionException {
    ...
    public boolean actualizar(Supermercados message) throws IOException, InterruptedException, ExecutionException {
        final String corrId = UUID.randomUUID().toString();
    ...
    public Supermercados obtenerID(int id) throws IOException, InterruptedException, ExecutionException {
        final String corrId = UUID.randomUUID().toString();
        ...
        final CompletableFuture<Supermercados> response = new CompletableFuture<>();
    ...
    public Supermercados[] listar() throws IOException, InterruptedException, ExecutionException {
        final String corrId = UUID.randomUUID().toString();
